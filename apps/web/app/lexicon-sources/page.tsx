...
/**
 * صفحة مصادر المعاجم — البيت الذي انتقلت إليه سجلات الإسناد.
 *
 * كانت قوائم «اقرأ المادة عند» وما فحص من المصادر وبيانات الطبعات
 * تعرض داخل ركن المادة المعجمية في كل صفحة، فتثقل القراءة وتشتت
 * القارئ (قرار المالك 2026-08-01). هنا مكانها: من أراد الإسناد وجده
 * كاملا، ومن جاء يقرأ لم يزاحم.
 */
