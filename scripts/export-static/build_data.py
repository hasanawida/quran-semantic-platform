...
def main() -> None:
    ...
    write(
        "lexicon.json",
        {
            ...
            "lane": None,
            "reason": (
                "**المواد مفتوحةٌ بمواضعها، ومتونها غير مُدخَلة.** لم يجتز "
                ...
                "لكن طبقة نصِّها المستخرَجة آليًّا **غير صالحة** — فإدخالها "
            ...
            "sources": [
                ...
                },
                {
                    ...
                    "note": (
                        ...
                        "(ت١٩٨٨)، دار الجيل، **١٤٢٠هـ/١٩٩٩م**؛ والمفردات — "
                        "كيلاني، دار المعرفة؛ وغريب القرآن — أحمد صقر، دار "
                        "الكتب العلمية «**لعلها** مصورة عن الطبعة المصرية». "
