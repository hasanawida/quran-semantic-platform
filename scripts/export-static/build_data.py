...
def main() -> None:
    ...
    write(
        "lexicon.json",
        {
            ...
            "lane": lane_meta,
            "reason": (
                "**المعنى بالعربية غير مُدخَل بعد.** لم يجتز أيُّ معجمٍ "
                "عربيٍّ رقميّ شرطَ «الكتاب + الطبعة + الملف + الترخيص + "
                "البصمة»: المتداول منها نصٌّ واحد من طبعةٍ لم يُسمِّها أحد، "
                "ولا مصوَّرةَ مؤكَّدةً قبل ١٩٢٩ لمعجمٍ قرآنيّ يُعرَّف ضوئيًّا. "
                "والمعروض هنا **شاهدٌ إنجليزي** — معجم لِين بطبعته وصفحاته "
                "— يقوم مقام الدليل لا مقام المعنى العربي، ولا يُسدّ به "
                "الفراغ ولا يُترجَم آليًّا."
            ),
            ...
            "sources": [
                ...
                {
                    "name": "مفردات الراغب — المطبعة الميمنية 1906",
                    "url": "https://dlib.nyu.edu/aco/",
                    "licence": "ملكية عامة — نصًّا وترقيمًا (ما قبل 1929)",
                    "status": "candidate",
                    "note": (
                        "مقصورٌ على ألفاظ القرآن فيلتحم بفهرس الجذور. "
                        "يحتاج تعرّفًا ضوئيًّا ومراجعةً بشرية موثَّقة لكل "
                        "صفحة تُنشر (§24٫6)."
                    ),
                },
            ],
