...
def main() -> None:
    ...
    if tafsir_path.exists():
        ...
        tafsir_meta["further_reading_note"] = (
            "هذه إحالاتٌ لا متون: كتبٌ نافعة مؤلفوها معاصرون، ونصُّها من "
            "إنشائهم لا من متون القدماء — فلا يُنقل منها حرفٌ بلا إذنٍ "
            "مكتوب. تُسمّى بإسنادها ليقرأها من أرادها عند صاحبها، "
            "وطلباتُ الإذن مسجَّلة في docs/permissions/REQUESTS.md؛ ومتى "
            "وصل جوابٌ دخل المتن كما دخل تفسيرا البغوي وابن كثير."
        )
